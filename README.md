...
The source code in the `WordHide.java` file must also pass additional
tests set by the [GatorGrader
tool](https://github.com/GatorEducator/gatorgrader). For instance, GatorGrader
will check to ensure that `WordHide` produces exactly ten lines of
...
```
Gregory M. Kapfhammer Tue Oct 08 10:55:26 EDT 2019
...
- The WordHide.java in src/main/java/labfive has at least 1 of the `charAt(` fragment
- The WordHide.java in src/main/java/labfive has at least 1 of the `public class WordHide` fragment
- The WordHide.java in src/main/java/labfive has at least 1 of the `substring(` fragment
- The WordHide.java in src/main/java/labfive has at least 4 single-line Java comment(s)
- The WordHide.java in src/main/java/labfive has exactly 0 of the `Add Your Name Here` fragment
- The WordHide.java in src/main/java/labfive has exactly 0 of the `TODO` fragment
- The WordHide.java in src/main/java/labfive has exactly 1 of the `import java.io.File;` fragment
- The WordHide.java in src/main/java/labfive has exactly 1 of the `import java.io.FileNotFoundException;` fragment
- The WordHide.java in src/main/java/labfive has exactly 1 of the `import java.util.Date;` fragment
- The WordHide.java in src/main/java/labfive has exactly 1 of the `new Date()` fragment
- The WordHide.java in src/main/java/labfive has exactly 1 of the `package labfive;` fragment
- The WordHide.java in src/main/java/labfive has exactly 2 multiple-line Java comment(s)
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command output has exactly 24 lines
- The file WordHide.java exists in the src/main/java/labfive directory
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 24/24 (100%) of checks for cs100-F2019-lab5! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-lab5-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab5-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab5-starter/issues).
